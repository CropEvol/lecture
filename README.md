...
<div style="padding: 10px; margin-bottom: 10px; border: 1px solid #333333; border-radius: 10px;"><span style="font-weight:bold;">＊重要＊
メールの件名を HW[課題番号(2桁)]+SID[学籍番号(4桁-2桁-４桁)]（すべて半角英数） にしてください。課題番号は各課題ファイル内に記載しています。  
